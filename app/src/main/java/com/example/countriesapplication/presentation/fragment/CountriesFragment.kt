    ...
    private fun setUpFilterCategoriesRv() {
        ...
        nestedAdapter.expressionViewHolderBinding = { item, viewBinding ->
            ...
            binding.filterCheckbox.setOnClickListener {
                ...
                if (binding.filterCheckbox.isChecked){
                    filterBottomSheetBinding.bottomButtons.visibility = View.VISIBLE
                }
            }
        }
        ...
        filterAdapter.expressionViewHolderBinding = { item, viewBinding ->
            ...
            nestedAdapter.listOfItems = item.nestedList

            binding.nestedRv.layoutManager = LinearLayoutManager(context)
            binding.nestedRv.adapter = nestedAdapter
...
//            }
    ...
    private fun showBottomSheetButtons(){
        filterBottomSheetBinding
    }
